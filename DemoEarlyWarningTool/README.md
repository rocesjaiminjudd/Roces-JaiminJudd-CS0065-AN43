...
This repository contains the required output for the asynchronous activity. The project uses KNIME to predict student risk status from academic performance data.
...
* `Roces_Jaimin_KNIME_GitHub_Evidence.pdf` - evidence screenshots
